...
public class ServerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(82, 118, 129));

        jPanel3.setBackground(new java.awt.Color(111, 143, 153));
        ...
        ActiveUsersList.setBackground(new java.awt.Color(82, 118, 129));
        ActiveUsersList.setForeground(new java.awt.Color(206, 206, 206));
        ActiveUsersList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = {};
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane2.setViewportView(ActiveUsersList);
    ...
    public void updateActivity(String message) {
        ServerAreaText += "\n"  + message;
        ServerArea.setText(ServerAreaText);
    }

    public void updateActiveList(String list) {
        ActiveUsersList.setModel(new javax.swing.AbstractListModel<String>() {
